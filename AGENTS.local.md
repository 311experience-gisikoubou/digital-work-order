...
## Real-Device Preview Identity Gate

Before giving a human any iPad/Safari verification URL, the AI must use a target-commit clean worktree and a dedicated preview port, then run `tools/real-device-preview-gate.mjs`.
